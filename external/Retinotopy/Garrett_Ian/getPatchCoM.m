...
%gets the center of mass (CoM) and principle axis of all patches in image
...
for i = 1:length(areaID)-1
    ...
    %If the patch is curved the CoM will not be on the patch, which screws things up later
