function [Jac, prefAxisMF, Distrtion] = getMagFactors(kmap_hor,kmap_vert,pixpermm)
...
Jac = (dhdx.*dvdy - dvdx.*dhdy)*pixpermm^2; %deg^2/mm^2 %mag fact is determinant of Jac (MA: eq 4 Garrett 2014)
